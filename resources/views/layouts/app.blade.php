                ...
                <div class="w-full container mx-auto flex flex-wrap items-center mt-0 pt-3 pb-3 lg:pb-0">
                    ...
                    <div class="w-1/2 pr-0">
                        ...
                        <div class="relative text-sm text-gray-100">
                            <button id="userButton" class="sm:w-32 flex items-center focus:outline-none mr-3">
                            ...
                            <div id="userMenu" class="bg-gray-900 rounded shadow-md mt-2 absolute mt-8 top-0 right-0 min-w-full overflow-auto z-30 invisible border border-gray-100">
                                <ul class="list-reset">
